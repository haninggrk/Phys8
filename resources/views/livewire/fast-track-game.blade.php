      ...
      <main class="flex-1 mt-20 relative overflow-y-auto focus:outline-none">
        <div class="py-6">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div class="py-4">
                <div style="height:400px" class="border-4 my-4 py-5 px-4 w-full overflow-hidden gradientcolor3 border-gray-200 rounded-3xl">
                    <h2 class="text-5xl mb-2 font-extrabold text-white">Kategori Fast Track</h2>
                    <h2 class="text-1xl text-white mt-10">{{ $getCategory->description }}</h2>
                    <div class="text-center mt-20">
                    <button x-on:click="open = ! open" class=" bg-blue-500 w-full hover:bg-blue-600 text-white font-semibold py-3 mb-10 text-xl px-4 border border-white rounded shadow">
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          ...
          <h2 class="text-5xl mt-20 mb-5 font-extrabold text-white">Pilih Level</h2>
